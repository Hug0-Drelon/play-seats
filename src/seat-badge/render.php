...
$playSeatsWrapperAttributes = get_block_wrapper_attributes(
	[
		'class'      => 'play-seats-badge',
		'role'       => 'status',
		'aria-label' => __( 'Remaining seats', 'play-seats' ),
		'aria-busy'  => 'true',
	]
);
...
<div <?php echo $playSeatsWrapperAttributes; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Escaped by WordPress. ?>>
	<span class="play-seats-badge__count">
